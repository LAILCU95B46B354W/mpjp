...
public class AboutMath { // non è una vera e propria classe ma serve per fare principalmente i calcoli,
							// prima di scrivere un codice nostro guardiamo qui se c'è già una funzione che
							// a noi serve
